        ...
        <div className="bg-gradient-to-b from-background via-muted/20 to-background">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold mb-6">
              Sculpt and <span className="text-gradient-hero">Strive</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              Sculpt and Strive is a results-driven fitness brand dedicated to
              helping individuals of all ages and fitness levels achieve their
              health goals. Led by USA certified coaches:
            </p>
          </div>

          {/* Coaches Information */}
          <div className="max-w-2xl mx-auto grid grid-cols-2 gap-4 py-6 px-4">
          ...
          {/* About Us Stats */}
          <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto mb-12 px-4">
            {aboutUsStats.map((stat) => (
              <div
                key={stat.label}
                className="text-center border py-3 px-2 rounded-md  animate-slide-up transition-all duration-300 hover:shadow-glow"
              >
          ...
          <div className="w-full flex flex-col gap-4 max-w-3xl mx-auto text-center py-8 pb-8 px-4">
            <h2 className="text-xl font-bold">
              OUR STORY: FITNESS THAT MOVES WITH YOU
            </h2>
            <p className="text-lg">
              At Sculpt & Strive, fitness fits your life...
            </p>
            <p className="text-lg">
              Whether you’re working out at home, at the gym, or while
              traveling, our flexible programs make it easy to stay consistent
              anywhere.
            </p>
            <p className="text-lg">
              We design programs that go beyond the physical—focusing on your{" "}
              <span className="font-bold">
                strength, mobility, confidence, and overall well-being.
              </span>
            </p>
          </div>

          {/* Our Mission and Vision */}
          <div className="grid md:grid-cols-2 py-6 px-4 gap-6 max-w-5xl mx-auto mb-10">
            {motto.map((motive, index) => (
              <MotiveCard key={motive.heading} {...motive} />
            ))}
          </div>
        </div>
      </section>
