        ...
        <div className="grid lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-accent-foreground/70 mb-6 max-w-sm">
              Your personalized fitness journey starts here. From prenatal to senior fitness, 
              we meet you exactly where you are.
            </p>
            
            {/* Contact Info */}
            <div className="space-y-3 mb-6">
              <a href="mailto:hello@sculptandstrive.com" className="flex items-center gap-3 text-accent-foreground/70 hover:text-primary transition-colors">
                <Mail className="w-4 h-4" />
                info@sculptandstrive.com
              </a>
              <a href="tel:+1234567890" className="flex items-center gap-3 text-accent-foreground/70 hover:text-primary transition-colors">
                <Phone className="w-4 h-4" />
                +91 7302113369
              </a>
              <div className="flex items-center gap-3 text-accent-foreground/70">
                <MapPin className="w-4 h-4" />
                Sector 1 Meerut Uttar Pradesh India 250103.
              </div>
            </div>
